...
namespace Microsoft.VisualStudio.Mac.LanguageServices.Razor.ProjectSystem
{
    internal class DefaultDotNetProjectHost : DotNetProjectHost
    {
        ...
        private void UpdateRazorHostProject()
        {
            _foregroundDispatcher.AssertForegroundThread();
        ...
        private bool TryGetProjectSnapshotManager(out ProjectSnapshotManagerBase projectSnapshotManagerBase)
        {
            ...
            var projectSnapshotManager = languageService.GetRequiredService<ProjectSnapshotManager>();

            if (!(projectSnapshotManager is ProjectSnapshotManagerBase projectSnapshotManagerImpl))
            {
                projectSnapshotManagerBase = null;
                return false;
            }

            projectSnapshotManagerBase = projectSnapshotManagerImpl;
            return true;
        }
